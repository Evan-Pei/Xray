...
- **Admin editing pages** — manage machines at `/admin/machines` and bookings at `/admin/bookings`
...
Demo data is stored in a local SQLite database (`instance/xray.db` by default) and is automatically seeded the first time the app starts.
...
5. Use **Manage Machines** and **Manage Bookings** to create, edit, or delete records from the browser
